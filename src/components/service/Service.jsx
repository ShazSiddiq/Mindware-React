      ...
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap">
          <ServiceCard
            title="
            Business Consulting"
            details="A business consultant specializing in RFID (Radio-Frequency Identification) technology provides expert guidance and strategic advice to organizations looking to leverage RFID solutions for various purposes."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            title="
            software solution"
            details="Unlocking the Power of RFID Technology: Your Trusted RFID Software Solution : Our team of seasoned RFID experts possesses a deep understanding of the technology, its applications, and its potential to transform businesses"
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="In today's competitive landscape, RFID (Radio-Frequency Identification) technology presents unparalleled opportunities for businesses. At MINDWARE], We specialize in RFID Sales and Marketing, helping you unlock .."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="At MINDWARE, we specialize in RFID (Radio-Frequency Identification) Productivity Improvement, providing innovative solutions that help organizations optimize processes, reduce costs, and boost efficiency."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradise"
            icon={
              <svg
                width="36"
                height="36"
